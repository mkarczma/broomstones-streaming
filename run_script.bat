...
C:\Users\techn\Documents\streaming-scripting\youtube_api\Scripts\python.exe youtube-streaming.py   --stream_title %stream_title% --sheet %sheet_name% --obs_path "C:\Program Files\obs-studio\bin\64bit\obs64.exe" --schedule_file manual_schedule.json --club_calendar https://broomstones.com/index.php/events/club-calendar --debug__print_upcoming_calendar_types --broadcast_prefix Derby Presidents Regatta Griffin "Curling McCurlFace" "Chowder Bowl" "Loving Cup" Finlay
